...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.vehicles_connection_status = QtGui.QListView(self.groupBox_3)
        self.vehicles_connection_status.setGeometry(QtCore.QRect(40, 50, 51, 131))
        self.vehicles_connection_status.setObjectName(_fromUtf8("vehicles_connection_status"))
        self.vehicles_armed_status = QtGui.QListView(self.groupBox_3)
        self.vehicles_armed_status.setGeometry(QtCore.QRect(120, 50, 51, 131))
        self.vehicles_armed_status.setObjectName(_fromUtf8("vehicles_armed_status"))
        self.vehicles_mode_status = QtGui.QListView(self.groupBox_3)
        self.vehicles_mode_status.setGeometry(QtCore.QRect(190, 50, 51, 131))
        self.vehicles_mode_status.setObjectName(_fromUtf8("vehicles_mode_status"))
        self.vehicles_battery_status = QtGui.QListView(self.groupBox_3)
        self.vehicles_battery_status.setGeometry(QtCore.QRect(270, 50, 51, 131))
